-- users populate information


INSERT INTO users (name, email, password) VALUES ('Eva Stanley', 'sebastianguerra@ymail.com', '402ABC4B2A76B9719D911' );
INSERT INTO users (name, email, password) VALUES ('Louisa Meyer', 'jacksonrose@hotmail.com', '$2a$10$FB' );
INSERT INTO users (name, email, password) VALUES ('Dominic Parks', 'victoriablackwell@outlook.com', 'BOAVhpuLvpOREQVmvmezD4ED' );
INSERT INTO users (name, email, password) VALUES (' Sue Luna', ' jasonvincent@gmx.com', ' JBIDRh70tGevYzYzQgFId2u' );
INSERT INTO users (name, email, password) VALUES ('Rosalie Garza', 'jacksondavid@gmx.com', 'EA883C10C4C49F97F1D2DDBDB' );
INSERT INTO users (name, email, password) VALUES ('Etta West ', 'charlielevy@yahoo.com', '8FF4575538D554FB29F8E' );
INSERT INTO users (name, email, password) VALUES ('Margaret Wong', 'makaylaweiss@icloud.com', '6FB58AAAA45C5E62DCBA3fgh' );
INSERT INTO users (name, email, password) VALUES ('Leroy Hart', 'jaycereynolds@inbox.com', 'C67983309FD9588476B008' );
